// Download latin woff2 subsets for the display + label fonts from Google Fonts.
// Saved into vendor/fonts/ so the build can inline them as base64 @font-face.
// If anything fails, the experience falls back to system serif stacks.
...
const families = [
  { css: 'https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,500;0,600;1,500&display=swap', tag: 'cormorant' },
  { css: 'https://fonts.googleapis.com/css2?family=Jost:wght@300;400&display=swap', tag: 'jost' },
];
