    ...
    <section className="py-[120px] bg-surface-container-low reveal noise-texture overflow-hidden">
      ...
      <div className="max-w-screen-2xl mx-auto px-4 md:px-16 mb-12">
        <div className="section-gold-rule">
          <h2 className="font-headline-lg text-[48px] md:text-[64px] leading-[1.0] tracking-[-0.02em] font-light text-on-surface gradient-title-bg heading-shimmer reveal reveal-clip">
            Curated Collection
          </h2>
